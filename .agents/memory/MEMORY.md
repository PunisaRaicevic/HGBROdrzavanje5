...
- [Appflow chunk size limit](appflow-chunk-size-limit.md) — keep JS chunks <1MB but use ONE single vendor chunk; fine-grained vendor splits broke init order -> white screen.
