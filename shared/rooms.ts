// Spisak soba — izvor: Spisak_soba_-_Slovenska_plaza_i_Aleksandar (06.08.2026)
// Hotel Slovenska plaža: 1016 soba, Hotel Aleksandar: 223 soba

export const SLOVENSKA_PLAZA_ROOMS: string[] = [
  ...
  "1361", "1362", "1363", "1364", "1365", "1366", "1367", "1368", "2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012",
  ...
  "2413", "2414", "2415", "2416", "2417", "2418", "2419", "2420", "2421", "2422", "2423", "2424", "2425", "2426", "2427", "2428", "2429", "3001", "3002", "3003",
...
export const ALEKSANDAR_ROOMS: string[] = [
  "1369", "1370", "1371", "1372", "1373", "1374", "1375", "1376", "1377", "1378", "1379", "1380", "1381", "1382", "1383", "1384", "1385", "1386", "1387", "1388",
  "1389", "1390", "1391", "1392", "1393", "1394", "1396", "1397", "1398", "1399", "1400", "1414", "1415", "1416", "1417", "1418", "1419", "1420", "1421", "1422",
  "1423", "1424", "1425", "1426", "1427", "1428", "1429", "1430", "1431", "1432", "1433", "1434", "1435", "1436", "1437", "1438", "1439", "1440", "1441", "1442",
  "1443", "1444", "1445", "1446", "1447", "1448", "1449", "1450", "2430", "2431", "2432", "2433", "2434", "2435", "2436", "2437", "2438", "2439", "2440", "2441",
  ...
  "2566", "2567", "2568", "2569", "2570", "3220", "3221", "3222", "3223", "3224", "3225", "3226", "3227", "3228", "3229", "3230", "3231", "3232", "3233", "3234",
  "3235", "3236", "3237", "3238", "3239", "3240", "3241", "3242", "3243", "3244", "3245", "3246", "3247", "3248", "3249", "3250", "3251", "3252", "3253", "3254",
  "3255", "3256", "3257",
];

// Ključevi su normalizovani: mala slova, bez dijakritika, bez suvišnih razmaka —
// tako "Hotel Slovenska plaza" i "Hotel Slovenska plaža" oba pogađaju isti spisak.
function normalizeHotelKey(hotel: string): string {
  return hotel
    .normalize('NFD')
    .replace(/[\u0300-\u036f]/g, '')
    .toLowerCase()
...
const ROOM_SETS: Record<string, Set<string>> = {
  [normalizeHotelKey('Hotel Slovenska plaža')]: new Set(SLOVENSKA_PLAZA_ROOMS),
  [normalizeHotelKey('Hotel Aleksandar')]: new Set(ALEKSANDAR_ROOMS),
};

/**
 * Provjera unosa u polje "Soba":
 * - Tekstualni unos (recepcija, kuhinja...) je uvijek dozvoljen.
 * - Ako je unos broj (razmaci unutar broja se ignorišu, npr. "10 01" = "1001"),
 *   mora postojati na spisku soba izabranog hotela — ako hotel ima poznat spisak.
 * - Za hotele bez spiska (Mogren, Palas, custom...) unos se ne ograničava.
 * Vraća null ako je unos validan, ili poruku o grešci.
 */
export function validateSobaInput(soba: string, hotel?: string | null): string | null {
  if (!soba.trim()) return null;
  // ukloni sve razmake — "10 01" tretiramo kao "1001", a ne kao tekst
  const value = soba.replace(/\s+/g, '');
  if (!/^\d+$/.test(value)) return null; // tekstualna lokacija — dozvoljeno
  const hotelSet = hotel ? ROOM_SETS[normalizeHotelKey(hotel)] : undefined;
  if (hotelSet) {
    if (hotelSet.has(value)) return null;
    return 'Soba ' + value + ' ne postoji u spisku za ' + hotel + '. Provjerite broj sobe ili upišite naziv lokacije (npr. recepcija, kuhinja).';
  }
  // Za hotele bez poznatog spiska (Mogren, Palas...) ne ograničavamo unos.
  return null;
}
