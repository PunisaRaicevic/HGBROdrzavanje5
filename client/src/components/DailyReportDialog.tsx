...
import { Download, Calendar, User, MapPin, Clock, CheckCircle, XCircle } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-[1000px] max-h-[90vh]" data-testid="dialog-daily-report">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4 text-sm text-muted-foreground">
            ...
            <span>•</span>
            <span>Završeno: <strong className="text-green-600">
              {todaysTasks.filter(t => t.status === 'completed').length}
            </strong></span>
            <span>•</span>
            <span>U toku: <strong className="text-blue-600">
